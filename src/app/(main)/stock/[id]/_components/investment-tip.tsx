...
export const InvestmentTip = React.memo(({ exDividendDate, earliestPaymentDate }: InvestmentTipProps) => {
  return (
    <div className="flex w-full flex-col border-b border-gray-200 px-5 py-8">
        ...
        <div className="flex items-center justify-between">
          {exDividendDate && (
            <>
              ...
              <p className="text-h5 text-gray-800">{formatDateStringToMonthDay(exDividendDate)}</p>
            </>
          )}
        </div>
        <div className="flex items-center justify-between">
          {earliestPaymentDate && (
            <>
              ...
              <p className="text-h5 text-gray-800">{formatDateStringToMonthDay(earliestPaymentDate)}</p>
            </>
          )}
        </div>
      </div>
